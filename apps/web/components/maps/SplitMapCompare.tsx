    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-black">
      ...
      <div className="flex flex-1">
        ...
        <div className="relative flex-1 border-r border-neutral-800">
          ...
          <div className="absolute left-3 top-3 rounded-lg border border-map-border bg-[#1a1d27] px-3 py-1.5 text-xs font-medium text-white">
            {leftLabel}
          </div>
        </div>
        ...
        <div className="relative flex-1">
          ...
          <div className="absolute right-3 top-3 rounded-lg border border-map-border bg-[#1a1d27] px-3 py-1.5 text-xs font-medium text-white">
            {rightLabel}
          </div>
        </div>
      </div>

      ...
      <div className={cn("flex h-full w-full items-center justify-between", isChatPage ? "gap-2" : "gap-3")}>
        ...
        >
          <div className={cn("flex items-center", isChatPage ? "gap-2" : "gap-3")}>
            <div className={cn(
              "hidden h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-border bg-background md:flex",
        ...
        {!isMobile && !isChatPage && (
          <div className="hidden flex-[0_1_34rem] xl:block">
            <div
              className={cn(
                "relative flex h-11 items-center rounded-[20px] border border-border bg-background px-3 shadow-[0_18px_45px_-38px_rgba(15,23,42,0.42)] transition-all",
                searchFocused && "border-foreground/32 bg-background"
              )}
              role="button"
              tabIndex={0}
            ...
            >
              ...
              <div className="flex items-center gap-2 text-xs text-muted-foreground">
                ...
                <kbd className="rounded-md border border-border bg-background px-1.5 py-0.5 font-mono">
                  {commandKeyLabel === "⌘" ? (
                ...
                <kbd className="rounded-md border border-border bg-background px-1.5 py-0.5 font-mono">K</kbd>
              </div>
            </div>
          </div>
        )}
        ...
        <div className={cn("flex items-center", isChatPage ? "gap-1.5" : "gap-2")}>
          <div className={cn(
            "flex items-center gap-1 rounded-[20px] border border-border bg-background p-1 shadow-[0_18px_45px_-38px_rgba(15,23,42,0.42)]",
            isChatPage && "rounded-2xl bg-background",
          )}>
            <Button
              variant="ghost"
              size="icon"

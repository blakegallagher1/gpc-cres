...
module.exports = [
  ...
  },
  {
    files: [
      ...
      "lib/automation/entitlementStrategy.ts",
      "lib/automation/outcomeCapture.ts",
      "lib/automation/agentLearningOutcomeReinforcement.ts",
      "lib/automation/taskExecution.ts",
      "lib/agent/researchRouting.ts",
      "lib/agent/loggerAdapter.ts",
      "lib/chat/mapActionTypes.ts",
      "lib/chat/mapFeatureUtils.ts",
      "lib/chat/toolResultWrapper.ts",
      ...
      "lib/schemas/intentClassification.ts",
      "lib/schemas/memoryWrite.ts",
      "lib/server/observability.ts",
      "lib/server/observabilityStore.ts",
      "lib/server/requestContext.ts",
      "lib/server/propertyDbEnv.ts",

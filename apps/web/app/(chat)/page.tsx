  ...
  return (
    <main className="relative overflow-hidden bg-transparent text-foreground">
      ...
      <section className="mx-auto flex min-h-[100svh] w-full max-w-7xl flex-col px-5 pb-14 pt-6 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_18rem] lg:items-start lg:gap-16">
          <div className="max-w-5xl">
            ...
            <h1 className="mt-8 max-w-[10.5ch] text-[clamp(4rem,8.6vw,7.75rem)] leading-[0.9] font-semibold tracking-[-0.075em]">
              ...
              <span className="mt-2 block">and small-format industrial assets</span>
              <span className="mt-2 block text-foreground/78">under 50,000 SF.</span>
            </h1>
            ...
            <div className="mt-10 max-w-3xl border-t border-border/55 pt-6">
              <div className="grid gap-5 sm:grid-cols-2">
                <div>
                  ...
                  <p className="mt-2 text-sm font-medium tracking-[-0.02em] text-foreground/88 sm:text-base">
                    Buy and develop communities where durable demand and disciplined basis create room for real operating work.
                  </p>
                </div>
                <div>
                  <p className="font-mono text-[0.66rem] uppercase tracking-[0.24em] text-muted-foreground">
                  ...
                  <p className="mt-2 text-sm font-medium tracking-[-0.02em] text-foreground/88 sm:text-base">
                    Buy and develop infill industrial and flex-warehouse assets under 50,000 SF where usability, access, and local scarcity matter.
                  </p>
                </div>
              </div>
              <p className="mt-5 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
                Gallagher Property Company is built around functional real estate, with one operating discipline applied across both lanes.
              </p>
        ...
        <div id="focus" className="mt-14 border-t border-border/55 pt-8">

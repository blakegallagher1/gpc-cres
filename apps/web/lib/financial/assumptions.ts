// Pure financial-model assumption types and defaults. Shared by the client-side
// Zustand store (`apps/web/stores/financialModelStore.ts`) and server-side
// services in `packages/server/src/services/**`. Keep this file free of
// zustand, react, or any side-effectful imports so it is safe to import from
// `packages/server`.

...
- Added build metadata (commit SHA/ref/provider) to `/api/health`, moved Vercel config to repo root, and updated the Vercel project settings to `frontend` + Next.js with Node 22 for correct builds.

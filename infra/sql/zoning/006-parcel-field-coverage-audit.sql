...
VALUES
    ...
    (50, 'source geography', 'source name', 'public', 'ebr_parcels', 'source_name', 'Original source system or endpoint name when captured.'),
    ...
    (210, 'site address', 'city', 'public', 'ebr_parcels', 'city', 'Physical/site city when source splits address fields.'),
    (220, 'site address', 'state', 'public', 'ebr_parcels', 'state', 'Physical/site state when source splits address fields.'),
    ...
    (370, 'owner', 'owner mailing address', 'public', 'ebr_parcels', 'owner_address', 'Mailing address from source when available.'),

    (400, 'legal and assessment', 'legal description', 'public', 'ebr_parcels', 'legal_description', 'Legal description from assessor/source.'),
    (410, 'legal and assessment', 'assessed value', 'public', 'ebr_parcels', 'assessed_value', 'Assessed value used by opportunity scoring.'),
    (420, 'legal and assessment', 'land value', 'public', 'ebr_parcels', 'land_value', 'Land-only assessed or market value when available.'),
    (430, 'legal and assessment', 'improvement value', 'public', 'ebr_parcels', 'improvement_value', 'Building/improvement value when available.'),
    (440, 'legal and assessment', 'market value', 'public', 'ebr_parcels', 'market_value', 'Total market value when available.'),
    (450, 'legal and assessment', 'tax amount', 'public', 'ebr_parcels', 'tax_amount', 'Current annual tax amount when available.'),
    (460, 'legal and assessment', 'last sale date', 'public', 'ebr_parcels', 'sale_date', 'Last transfer date when available.'),
    (470, 'legal and assessment', 'last sale price', 'public', 'ebr_parcels', 'sale_price', 'Last transfer price when available.'),

...
function deriveFeatureCenter(
  geometry: MapFeature["geometry"] | null | undefined,
...
export function mapFeaturesFromGeoJson(
  geojson: { features: Array<{ geometry?: MapFeature["geometry"] | null; properties?: Record<string, unknown> | null }> },
): MapFeature[] {
  return geojson.features
    .filter((feature): feature is { geometry: MapFeature["geometry"]; properties?: Record<string, unknown> | null } =>

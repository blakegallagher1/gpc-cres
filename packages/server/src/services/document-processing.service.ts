...
} from "./document-processing-persistence.service";
...
export class DocumentProcessingService {
  async processUpload(uploadId: string, dealId: string, orgId: string): Promise<ProcessUploadResult> {
  ...
  async getExtractionsByDeal(dealId: string, orgId: string): Promise<DocumentExtractionResponse[]> {
    return getDocumentExtractionsByDeal(dealId, orgId);
  }

  async getExtraction(extractionId: string, orgId: string): Promise<DocumentExtractionResponse | null> {

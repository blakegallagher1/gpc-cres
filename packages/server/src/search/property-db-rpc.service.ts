...
import {
  ...
  PROPERTY_DB_INTERNAL_SCOPE_HEADER,
...
export type { PropertyDbGatewayScope } from "./property-db-gateway.service";
export { PROPERTY_DB_INTERNAL_SCOPE_HEADER };
...
interface PropertyDbGatewayRequestOptions {
  ...
  internalScope?: import("./property-db-gateway.service").PropertyDbGatewayScope;
  timeoutMs?: number;
  maxRetries?: number;
}

export { getPropertyDbScopeHeaders };

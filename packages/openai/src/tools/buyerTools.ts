...
export const addBuyer = tool({
  ...
  parameters: z.object({
    ...
    company: z.string().optional().nullable().describe("Buyer's company name"),
    email: z.string().optional().nullable().describe("Buyer's email address"),
    phone: z.string().optional().nullable().describe("Buyer's phone number"),
    buyerType: z
    ...
    notes: z.string().optional().nullable().describe("Additional notes about the buyer"),
  }),
  execute: async ({
    orgId,
    name,
...
export const logOutreach = tool({
  ...
  parameters: z.object({
    ...
    notes: z.string().optional().nullable().describe("Notes about the contact attempt"),
    nextFollowupAt: z
      .string()
      .optional().nullable()
